...
SCRIPTS = [
{
  "title": "Wood was immortal for sixty million years",
  "hook": "For sixty million years, nothing on Earth could rot wood. It just piled up forever.",
  "story": "When trees first evolved woody tissue around three hundred and fifty million years ago, no organism on the planet had yet developed the ability to break it down. Lignin — the compound that makes wood hard — was essentially indestructible. Dead trees fell, were buried, and accumulated in vast layers without decomposing. This went on for sixty million years. The result is most of the coal we burn today — those ancient unrotted forests compressed under geological pressure for hundreds of millions of years. Eventually, white rot fungi evolved the enzymes to digest lignin, and the carbon cycle resumed. The age of unrotting wood is called the Carboniferous period, and we have been burning it ever since.",
  "outro": "The fuel powering modern civilisation is sixty-million-year-old wood that never got the chance to rot. We are burning a geological accident. Follow for more.",
  "tags": ["#nature", "#science", "#wood", "#history", "#shorts"],
  "hashtags": "#nature #science #wood #history #coal #shorts #fyp",
  "keywords": [
    "ancient forest prehistoric trees dramatic sky",  # hook pt1 — trees that never rotted
    "fallen log forest floor slowly decaying",        # hook pt2 — wood just piling up
    "lignin wood cross section microscope close",     # story pt1 — lignin, indestructible
    "coal mine layers geological strata dark",        # story pt2 — compressed into coal
    "white rot fungi mushroom decomposing log",       # story pt3 — fungi finally evolving
    "coal power plant burning industrial smoke",      # story pt4 — we burn it today
    "fire burning coal close up orange glow",         # outro pt1 — geological accident burning
    "ancient forest vast cinematic mist morning"      # outro pt2 — what we are really burning
  ],
  "music": "dramatic"
}
